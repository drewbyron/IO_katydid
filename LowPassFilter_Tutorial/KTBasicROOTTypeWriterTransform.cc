...
namespace Katydid
{
    ...
    void KTBasicROOTTypeWriterTransform::RegisterSlots()
    {
        ...
        fWriter->RegisterSlot("fs-fftw", this, &KTBasicROOTTypeWriterTransform::WriteFrequencySpectrumDataFFTW_LPF);
        fWriter->RegisterSlot("fs-polar", this, &KTBasicROOTTypeWriterTransform::WriteFrequencySpectrumDataPolar_LPF);
        fWriter->RegisterSlot("ps", this, &KTBasicROOTTypeWriterTransform::WritePowerSpectrum_LPF);  
